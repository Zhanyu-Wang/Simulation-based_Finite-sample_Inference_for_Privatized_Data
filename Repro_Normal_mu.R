...
scoreMCE <- function(optim_par, mu, data_randomness, privacy_noises, dp_statistic){
  sa <- optim_par
...
scoreMCE2 <- function(optim_par, data_randomness, privacy_noises, dp_statistic){
  mu <- optim_par[1]
  sa <- optim_par[2]
  return(scoreMCE(sa, mu, data_randomness, privacy_noises, dp_statistic))
}

accept <- function(proposed_mu, data_randomness, privacy_noises, n, dp_statistic) {
...
description_str <- paste("repro_mu-mu=", population_mu, 
